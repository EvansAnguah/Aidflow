...
<div class="row">
    ...
    <div class="col-12 mb-4">
        <div class="card border-0 shadow-sm bg-gradient text-white" style="background: linear-gradient(135deg, #0d6efd, #023e8a);">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($requests as $r): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= BASE_URL ?>/welfare/view/<?= $r['id'] ?>" class="btn btn-sm btn-outline-secondary">
